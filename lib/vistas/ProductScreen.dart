                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        subtitle: Text(producto.precio != null ? 'Precio: \$${producto.precio}' : ''),
                        trailing: IconButton(
                          icon: Icon(Icons.delete),
                          onPressed: () {
                            if (producto.id != null) {
                              _deleteProduct(producto.id!); // Usa el operador ! para indicarle a Dart que estás seguro de que el valor no es nulo
                            } else {
                              print('El ID del producto es nulo.'); // Opcional: Manejo de casos donde el ID es nulo
                            }
                          },
                        ),
                      );
